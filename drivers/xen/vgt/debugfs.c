...
int vgt_create_debugfs(struct vgt_device *vgt)
{
	...
	if (!perf_dir_entry)
		...
		debugfs_create_u64_node ("ppgtt_rp_cnt", 0444, perf_dir_entry, &(vgt->stat.ppgtt_rp_cnt));
		debugfs_create_u64_node ("ppgtt_rp_cycles", 0444, perf_dir_entry, &(vgt->stat.ppgtt_rp_cycles));
